...
@onready var actual_button = get_node("Actual Option Button")
...
func _ready() -> void:
	if property_to_mirror != null:
		...
		actual_button.select(grabbed_value)
